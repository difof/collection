...
func AsForwardLinkedList[V any](c Collection[int, V, Tuple[int, V]]) *ForwardLinkedList[V] {
...
func (s *ForwardLinkedList[V]) Get(index int) (v V, ok bool) {
...
func (s *ForwardLinkedList[V]) Iter() *Iterator[Tuple[int, V]] {
	return NewIterator[Tuple[int, V]](s)
}

func (s *ForwardLinkedList[V]) IterHandler(iter *Iterator[Tuple[int, V]]) {
	go func() {
		node := s.first
		for i := 0; i < s.size; i++ {
			select {
...
func (s *ForwardLinkedList[V]) AsIterable() Iterable[Tuple[int, V]] {
	return s
}

func (s *ForwardLinkedList[V]) Factory() Collection[int, V, Tuple[int, V]] {
	return NewForwardLinkedList[V]()
}

func (s *ForwardLinkedList[V]) FactoryFrom(values []V) Collection[int, V, Tuple[int, V]] {
	return NewForwardLinkedList[V](values...)
}

func (s *ForwardLinkedList[V]) Clone() Collection[int, V, Tuple[int, V]] {
...
func (s *ForwardLinkedList[V]) AsCollection() Collection[int, V, Tuple[int, V]] {
	return s
}
