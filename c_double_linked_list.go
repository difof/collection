...
func AsDoubleLinkedList[V any](c Collection[int, V, Tuple[int, V]]) *DoubleLinkedList[V] {
...
func (s *DoubleLinkedList[V]) Get(index int) (v V, ok bool) {
...
func (s *DoubleLinkedList[V]) Iter() *Iterator[Tuple[int, V]] {
	return NewIterator[Tuple[int, V]](s)
}

func (s *DoubleLinkedList[V]) IterHandler(iter *Iterator[Tuple[int, V]]) {
	go func() {
		node := s.first
		for i := 0; i < s.size; i++ {
			select {
...
func (s *DoubleLinkedList[V]) AsIterable() Iterable[Tuple[int, V]] {
	return s
}

func (s *DoubleLinkedList[V]) Factory() Collection[int, V, Tuple[int, V]] {
	return NewForwardLinkedList[V]()
}

func (s *DoubleLinkedList[V]) FactoryFrom(values []V) Collection[int, V, Tuple[int, V]] {
	return NewForwardLinkedList[V](values...)
}

func (s *DoubleLinkedList[V]) Clone() Collection[int, V, Tuple[int, V]] {
...
func (s *DoubleLinkedList[V]) AsCollection() Collection[int, V, Tuple[int, V]] {
	return s
}
